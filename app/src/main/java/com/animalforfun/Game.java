...
//การประกาศตัวแปล
    ...
    ImageButton volumnImageBotton;
    int questionCout =10; ///กำหนดจำนวนข้อ
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        volumnImageBotton = (ImageButton) findViewById(R.id.imvVolumn);

        for (int i = 1; i <= questionCout; i++) {
            qId.add(i);
